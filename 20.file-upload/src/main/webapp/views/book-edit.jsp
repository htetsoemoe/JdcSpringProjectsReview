					...
					<form:form  action="/book" cssClass="card-body" modelAttribute="book">
						...
						<div class="row mb-4">
							...
							<div class="col">
								...
								<form:input path="title" cssClass="form-control" placeholder="Enter Book Title"></form:input>
								<form:errors path="title" cssClass="text-danger"></form:errors>							
							</div>
							
							<div class="col">
								<label>Author</label>
								<form:input path="author" cssClass="form-control" placeholder="Enter Author Name"></form:input>
						...
						<div class="row mb-4">
							<div class="col-4">
								<label>Price</label>
								<form:input path="price" type="number" cssClass="form-control" placeholder="Enter Price"></form:input>
								<form:errors path="price" cssClass="text-danger"></form:errors>							
							</div>
							<div class="col">
								<label>Remark</label>
								<form:input path="remark" cssClass="form-control" placeholder="Enter Remark"></form:input>
							</div>
						</div>
						
						<div class="row">
							<div class="col">
								<button class="btn btn-primary">Save Book</button><!-- This button acts like submit button -->
							</div>
						</div>
					</form:form>
				</div>
